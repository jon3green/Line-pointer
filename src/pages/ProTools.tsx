              ...
              {[0.25, 0.5, 0.75, 1.0].map((f) => (
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg font-semibold ${
                    fraction === f ? 'bg-blue-600 text-white' : 'bg-gray-800 text-gray-400'
                  }`}
                >
                  {f === 1 ? 'Full' : `${f * 100}%`}
                </button>
        ...
        <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 rounded-lg p-6 border border-blue-800/30">
          ...
          <div className="space-y-4">
            <div className="bg-gray-900/60 rounded-lg p-4">
              <div className="text-gray-400 text-sm mb-1">Your Edge</div>
            ...
            <div className="bg-gray-900/60 rounded-lg p-4">
              <div className="text-gray-400 text-sm mb-1">Recommended Bet ({fraction * 100}% Kelly)</div>
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="bg-gray-900/60 rounded p-3">
                <div className="text-xs text-gray-400">Half</div>
...
function EVCalculator() {
  ...
  return (
    <div className="card">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gray-900/60 rounded-lg p-3">
                <div className="text-xs text-gray-400 mb-1">Profit if Win</div>
                <div className="text-lg font-bold text-green-400">+${result.profitIfWin.toFixed(2)}</div>
              </div>
              <div className="bg-gray-900/60 rounded-lg p-3">
                <div className="text-xs text-gray-400 mb-1">Loss if Lose</div>
                <div className="text-lg font-bold text-red-400">-${result.lossIfLose.toFixed(2)}</div>
              </div>
            </div>

            <div className="bg-gray-900/60 rounded-lg p-3">
              <div className="text-xs text-gray-400 mb-1">Break-Even Win Rate</div>
      ...
      <div className="bg-purple-900/20 border border-purple-800/30 rounded-lg p-4 text-sm text-gray-300">
        <h4 className="font-bold text-purple-400 mb-2">💡 EV Formula:</h4>
        <code className="block bg-gray-900 p-3 rounded font-mono text-xs">
    ...
    <div className="card">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className={`bg-gradient-to-br rounded-lg p-6 border ${
          ...
          <div className="space-y-4">
            <div className="bg-gray-900/60 rounded-lg p-4">
              <div className="text-gray-400 text-sm mb-1">CLV</div>
            ...
            <div className="bg-gray-900/60 rounded-lg p-3">
              <div className="text-xs text-gray-400 mb-1">Estimated EV Gain</div>
            ...
            <div className="bg-gray-900/60 rounded-lg p-4 text-sm">
              <div className="text-gray-300">{result.analysis}</div>
            </div>
      ...
      <div className="bg-green-900/20 border border-green-800/30 rounded-lg p-4 text-sm text-gray-300">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className={`rounded-lg p-4 border ${
              result.over.probability > 50 ? 'bg-green-900/40 border-green-800/30' : 'bg-gray-800/40 border-gray-700'
            }`}>
              <div className="text-xs text-gray-400 mb-1">Over {totalLine}</div>
              <div className="text-xl font-bold text-white">{result.over.probability.toFixed(1)}%</div>
            </div>
            <div className={`rounded-lg p-4 border ${
              result.under.probability > 50 ? 'bg-green-900/40 border-green-800/30' : 'bg-gray-800/40 border-gray-700'
            }`}>
              <div className="text-xs text-gray-400 mb-1">Under {totalLine}</div>
      ...
      <div className="bg-gray-800/50 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
          {result.scoreProbabilities.slice(0, 10).map((score, idx) => (
            <div key={idx} className="bg-gray-900/60 rounded p-2 text-center">
              <div className="text-white font-bold">{score.score}</div>
              <div className="text-xs text-gray-400">{score.probability.toFixed(2)}%</div>
            </div>
          ))}
        </div>
      </div>
...
function SharpDetector() {
  ...
  return (
    <div className="card">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className={`bg-gradient-to-br rounded-lg p-6 border ${
          result.confidence === 'high'
            ...
            : 'from-gray-900/40 to-gray-800/40 border-gray-700/30'
        }`}>
          <h3 className="text-lg font-bold text-white mb-4">
          ...
          <div className="space-y-4">
            <div className="bg-gray-900/60 rounded-lg p-4">
              ...
              <div className={`text-3xl font-bold ${
                ...
                result.confidence === 'low' ? 'text-blue-400' : 'text-gray-400'
              }`}>
            ...
            <div className="bg-gray-900/60 rounded-lg p-4 space-y-2">
              ...
              {result.indicators.length > 0 ? (
                ...
                <div className="text-sm text-gray-400">No sharp indicators detected</div>
              )}
            </div>
      ...
      <div className="mt-6 bg-orange-900/20 border border-orange-800/30 rounded-lg p-4 text-sm text-gray-300">
